...
) ENGINE=InnoDB AUTO_INCREMENT=210 DEFAULT CHARSET=latin1 COMMENT='Registro de apuestas realizadas';
...
INSERT INTO `banco_central_laplacio` VALUES (2116,65,1264,0,13.1077);
...
INSERT INTO `participantes` VALUES (1,'DAVID',0,'DAVID'),(2,'LORE',120,'LORE'),(3,'SOFI',139,'SOFI'),(4,'SERGIO',15,'SERGIO'),(5,'PAULA',160,'PAULA'),(11,'LUIS MIGUEL',0,'LUIS'),(12,'PEDRO',0,'PEDRO'),(13,'MYRI',45,'MYRI'),(14,'KATY',5,'KATY'),(15,'JUAN CARLOS',90,'JUAN'),(16,'ALEXANDER',45,'ALEXANDER'),(17,'ANDRES',91,'ANDRES'),(18,'MARU',92,'MARU');
...
) ENGINE=InnoDB AUTO_INCREMENT=149 DEFAULT CHARSET=latin1 COMMENT='Transacciones de laplacios';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-06-18  2:25:08
