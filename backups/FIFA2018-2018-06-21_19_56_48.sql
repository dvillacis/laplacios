...
) ENGINE=InnoDB AUTO_INCREMENT=331 DEFAULT CHARSET=latin1 COMMENT='Registro de apuestas realizadas';
...
INSERT INTO `banco_central_laplacio` VALUES (3942,85,2046,0,46.3765);
...
INSERT INTO `participantes` VALUES (1,'DAVID',141,'DAVID'),(2,'LORE',575,'LORE'),(3,'SOFI',376,'SOFI'),(4,'SERGIO',150,'SERGIO'),(5,'PAULA',265,'PAULA'),(11,'LUIS MIGUEL',246,'LUIS'),(12,'PEDRO',882,'PEDRO'),(13,'MYRI',100,'MYRI'),(14,'KATY',10,'KATY'),(15,'JUAN CARLOS',790,'JUAN'),(16,'ALEXANDER',15,'ALEXANDER'),(17,'ANDRES',111,'ANDRES'),(18,'MARU',176,'MARU'),(19,'GIORGINO',105,'GIORGINO');
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=latin1 COMMENT='Partidos disponibles';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=220 DEFAULT CHARSET=latin1 COMMENT='Transacciones de laplacios';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-06-21 19:56:48
