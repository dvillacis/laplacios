...
) ENGINE=InnoDB AUTO_INCREMENT=363 DEFAULT CHARSET=latin1 COMMENT='Registro de apuestas realizadas';
...
INSERT INTO `banco_central_laplacio` VALUES (7804,85,2446,0,91.8118);
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=latin1 COMMENT='Informacion de participantes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `participantes` VALUES (1,'DAVID',331,'DAVID'),(2,'LORE',945,'LORE'),(3,'SOFI',600,'SOFI'),(4,'SERGIO',530,'SERGIO'),(5,'PAULA',395,'PAULA'),(11,'LUIS MIGUEL',566,'LUIS'),(12,'PEDRO',1860,'PEDRO'),(13,'MYRI',85,'MYRI'),(14,'KATY',30,'KATY'),(15,'JUAN CARLOS',2090,'JUAN'),(16,'ALEXANDER',0,'ALEXANDER'),(17,'ANDRES',111,'ANDRES'),(18,'MARU',156,'MARU'),(19,'GIORGINO',105,'GIORGINO');
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=latin1 COMMENT='Partidos disponibles';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=233 DEFAULT CHARSET=latin1 COMMENT='Transacciones de laplacios';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-06-22 19:57:25
