  ...
  if (empty($id_partido) || $apuesta_equipo_1<0 || $apuesta_equipo_2<0 || empty($apuesta_valor)){
    ...
    if ($valid_query_row > 0) {
      ...
      if ($apuesta_valor <= $login_saldo){
        ...
        $mysql_query_string = "INSERT INTO apuestas (id_participante, id_partido, apuesta_equipo_1, apuesta_equipo_2, penales_check, apuesta_valor, apuesta_fecha, apuesta_hora,procesada) VALUES ('$login_id', '$id_partido','$apuesta_equipo_1','$apuesta_equipo_2','$apuesta_check_penales','$apuesta_valor','$date','$time',0)";
