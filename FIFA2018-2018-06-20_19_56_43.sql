...
) ENGINE=InnoDB AUTO_INCREMENT=298 DEFAULT CHARSET=latin1 COMMENT='Registro de apuestas realizadas';
...
INSERT INTO `banco_central_laplacio` VALUES (579,85,1706,0,21.1125);
...
INSERT INTO `participantes` VALUES (1,'DAVID',91,'DAVID'),(2,'LORE',100,'LORE'),(3,'SOFI',0,'SOFI'),(4,'SERGIO',0,'SERGIO'),(5,'PAULA',80,'PAULA'),(11,'LUIS MIGUEL',36,'LUIS'),(12,'PEDRO',0,'PEDRO'),(13,'MYRI',30,'MYRI'),(14,'KATY',0,'KATY'),(15,'JUAN CARLOS',0,'JUAN'),(16,'ALEXANDER',0,'ALEXANDER'),(17,'ANDRES',111,'ANDRES'),(18,'MARU',26,'MARU'),(19,'GIORGINO',105,'GIORGINO');
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=latin1 COMMENT='Partidos disponibles';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=180 DEFAULT CHARSET=latin1 COMMENT='Transacciones de laplacios';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-06-20 19:56:44
