...
--
-- Host: localhost    Database: FIFA2018
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=latin1 COMMENT='Registro de apuestas realizadas';
...
INSERT INTO `banco_central_laplacio` VALUES (1010,55,18.3636);
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=latin1 COMMENT='Informacion de participantes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `participantes` VALUES (1,'DAVID',55,'DAVID'),(2,'LORE',70,'LORE'),(3,'SOFI',59,'SOFI'),(4,'SERGIO',55,'SERGIO'),(5,'PAULA',30,'PAULA'),(11,'LUIS MIGUEL',5,'LUIS'),(12,'PEDRO',190,'PEDRO'),(13,'MYRI',95,'MYRI'),(14,'KATY',45,'KATY'),(15,'JUAN CARLOS',90,'JUAN'),(16,'ALEXANDER',20,'ALEXANDER');
...
INSERT INTO `partidos` VALUES (1,'RUSIA','ARABIA SAUDITA','2018-06-14','10:00:00',5,0,1),(3,'EGITPO','URUGUAY','2018-06-15','07:00:00',0,1,1),(5,'MARRUECOS','IRAN','2018-06-15','10:00:00',0,1,1),(7,'PORTUGAL','ESPANA','2018-06-15','13:00:00',3,3,1),(12,'FRANCIA','AUSTRALIA','2018-06-16','05:00:00',NULL,NULL,0),(13,'ARGENTINA','ISLANDIA','2018-06-16','08:00:00',NULL,NULL,0),(14,'PERU','DINAMARCA','2018-06-16','11:00:00',NULL,NULL,0),(15,'CROACIA','NIGERIA','2018-06-16','14:00:00',NULL,NULL,0),(20,'COSTA RICA','SERBIA','2018-06-17','07:00:00',NULL,NULL,0),(21,'ALEMANIA','MEXICO','2018-06-17','10:00:00',NULL,NULL,0),(22,'BRASIL','SUIZA','2018-06-17','13:00:00',NULL,NULL,0);
...
-- Dump completed on 2018-06-15 16:39:29
